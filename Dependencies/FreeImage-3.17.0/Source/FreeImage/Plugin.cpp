...
static void InitExcludedFormat(Plugin *plugin, int format_id) { }
		...
		*/
		...
		if (s_plugins) {
			...
			*/
			...
			s_plugins->AddNode(InitExcludedFormat, NULL, "TIFF"); //InitTIFF);
			s_plugins->AddNode(InitWBMP);
			s_plugins->AddNode(InitPSD);
			s_plugins->AddNode(InitCUT);
			s_plugins->AddNode(InitXBM);
			s_plugins->AddNode(InitXPM);
			s_plugins->AddNode(InitExcludedFormat, NULL, "DDS"); //InitDDS);
	        s_plugins->AddNode(InitGIF);
	        s_plugins->AddNode(InitExcludedFormat, NULL, "HDR"); //InitHDR);
			s_plugins->AddNode(InitExcludedFormat, NULL, "G3"); //InitG3);
			s_plugins->AddNode(InitSGI);
			s_plugins->AddNode(InitExcludedFormat, NULL, "EXR"); //InitEXR);
			s_plugins->AddNode(InitExcludedFormat, NULL, "J2K"); //InitJ2K);
			s_plugins->AddNode(InitExcludedFormat, NULL, "JP2"); //InitJP2);
			s_plugins->AddNode(InitPFM);
			s_plugins->AddNode(InitPICT);
			s_plugins->AddNode(InitExcludedFormat, NULL, "RAW"); //InitRAW);
			s_plugins->AddNode(InitExcludedFormat, NULL, "WEBP"); //InitWEBP);
#if !(defined(_MSC_VER) && (_MSC_VER <= 1310))
			s_plugins->AddNode(InitExcludedFormat, NULL, "JXR"); //InitJXR);
