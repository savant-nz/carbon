...
/**
 * Implementation of parallax mapping for GLSL. This is a shader component that is used by other shaders in order to
 * support parallax mapping.
 */
...
public:
    ...
    /**
     * Returns whether parallax mapping should be done under the given params. The params must specify parallax scale,
     * step count, and a normal map with height in the alpha.
     */
