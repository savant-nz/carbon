...
const auto toLinear = std::array<float, 256>{
    {0.0f,        0.000303527f, 0.000607054f, 0.000910581f, 0.00121411f, 0.00151763f, 0.00182116f, 0.00212469f,
     0.00242822f, 0.00273174f,  0.00303527f,  0.00334654f,  0.00367651f, 0.00402472f, 0.00439144f, 0.00477695f,
     0.00518152f, 0.00560539f,  0.00604883f,  0.00651209f,  0.00699541f, 0.00749903f, 0.00802319f, 0.00856812f,
     ...
     0.0512695f,  0.0528607f,   0.0544803f,   0.0561285f,   0.0578054f,  0.0595112f,  0.0612461f,  0.06301f,
     0.0648033f,  0.066626f,    0.0684782f,   0.0703601f,   0.0722719f,  0.0742136f,  0.0761854f,  0.0781874f,
     0.0802198f,  0.0822827f,   0.0843762f,   0.0865005f,   0.0886556f,  0.0908417f,  0.093059f,   0.0953075f,
     0.0975874f,  0.0998987f,   0.102242f,    0.104616f,    0.107023f,   0.109462f,   0.111932f,   0.114435f,
     ...
     0.351533f,   0.3564f,      0.361307f,    0.366253f,    0.371238f,   0.376262f,   0.381326f,   0.38643f,
     0.391573f,   0.396755f,    0.401978f,    0.40724f,     0.412543f,   0.417885f,   0.423268f,   0.428691f,
     0.434154f,   0.439657f,    0.445201f,    0.450786f,    0.456411f,   0.462077f,   0.467784f,   0.473532f,
     0.47932f,    0.48515f,     0.491021f,    0.496933f,    0.502887f,   0.508881f,   0.514918f,   0.520996f,
     0.527115f,   0.533276f,    0.53948f,     0.545725f,    0.552011f,   0.55834f,    0.564712f,   0.571125f,
     0.577581f,   0.584078f,    0.590619f,    0.597202f,    0.603827f,   0.610496f,   0.617207f,   0.62396f,
     0.630757f,   0.637597f,    0.64448f,     0.651406f,    0.658375f,   0.665387f,   0.672443f,   0.679543f,
...
Color Image::readSRGB8Pixel(const byte_t* data, unsigned int width, unsigned int height, unsigned int depth,
...
Color Image::readSRGBA8Pixel(const byte_t* data, unsigned int width, unsigned int height, unsigned int depth,
                             unsigned int x, unsigned int y, unsigned int z)
{
